...
// * @author XenoAmess
// */
//public interface IntMap<V> extends Map<Integer, V>, Primitive {
//    /**
...
//     * @since 1.2
//     */
//    interface IntEntry<V> extends Map.Entry<Integer, V> {
//        /**
...
//            return Integer.hashCode(getKeyPrimitive());
//        }
//
//        /**
...
//         * @since 1.8
//         */
//        public static <V> Comparator<IntEntry<V>> comparingByKey() {
//            return (Comparator<IntEntry<V>> & Serializable)
//                    (c1, c2) -> PrimitiveComparators.
//                            INT_COMPARATOR_INCREASING.
...
//         * @since 1.8
//         */
//        public static <V> Comparator<IntEntry<V>> comparingByKey(IntComparator cmp) {
...
//         * @since 1.8
//         */
//        public static <V> Comparator<IntEntry<V>> comparingByValue(Comparator<? super V> cmp) {
//            Objects.requireNonNull(cmp);
//            return (Comparator<IntEntry<V>> & Serializable)
