...
// * @author XenoAmess
// */
//public interface FloatMap<V> extends Map<Float, V>, Primitive {
//    /**
...
//     * @since 1.2
//     */
//    interface FloatEntry<V> extends Map.Entry<Float, V> {
//        /**
...
//         *                               required to, throw this exception if the entry has been
//         *                               removed from the backing map.
//         * @see FloatEntry#getKey();
//         */
//        float getKeyPrimitive();
//
//        /**
...
//            return Float.hashCode(getKeyPrimitive());
//        }
//
//        /**
...
//         * @since 1.8
//         */
//        public static <V> Comparator<FloatEntry<V>> comparingByKey() {
//            return (Comparator<FloatEntry<V>> & Serializable)
//                    (c1, c2) -> PrimitiveComparators.
//                            FLOAT_COMPARATOR_INCREASING.
...
//         * @since 1.8
//         */
//        public static <V> Comparator<FloatEntry<V>> comparingByKey(FloatComparator cmp) {
...
//         * @since 1.8
//         */
//        public static <V> Comparator<FloatEntry<V>> comparingByValue(Comparator<? super V> cmp) {
//            Objects.requireNonNull(cmp);
//            return (Comparator<FloatEntry<V>> & Serializable)
