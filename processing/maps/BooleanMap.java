...
// * @author XenoAmess
// */
//public interface BooleanMap<V> extends Map<Boolean, V>, Primitive {
//    /**
...
//     * @since 1.2
//     */
//    interface BooleanEntry<V> extends Map.Entry<Boolean, V> {
//        /**
...
//         *                               required to, throw this exception if the entry has been
//         *                               removed from the backing map.
//         * @see BooleanEntry#getKey();
//         */
//        boolean getKeyPrimitive();
//
//        /**
...
//            return Boolean.hashCode(getKeyPrimitive());
//        }
//
//        /**
...
//         * @since 1.8
//         */
//        public static <V> Comparator<BooleanEntry<V>> comparingByKey() {
//            return (Comparator<BooleanEntry<V>> & Serializable)
//                    (c1, c2) -> PrimitiveComparators.
//                            BOOLEAN_COMPARATOR_INCREASING.
...
//         * @since 1.8
//         */
//        public static <V> Comparator<BooleanEntry<V>> comparingByKey(BooleanComparator cmp) {
...
//         * @since 1.8
//         */
//        public static <V> Comparator<BooleanEntry<V>> comparingByValue(Comparator<? super V> cmp) {
//            Objects.requireNonNull(cmp);
//            return (Comparator<BooleanEntry<V>> & Serializable)
