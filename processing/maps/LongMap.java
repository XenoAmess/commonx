...
// * @author XenoAmess
// */
//public interface LongMap<V> extends Map<Long, V>, Primitive {
//    /**
...
//            return Long.hashCode(getKeyPrimitive());
//        }
//
//        /**
...
//         * @since 1.8
//         */
//        public static <V> Comparator<LongEntry<V>> comparingByKey() {
//            return (Comparator<LongEntry<V>> & Serializable)
//                    (c1, c2) -> PrimitiveComparators.
//                            LONG_COMPARATOR_INCREASING.
...
//         * @since 1.8
//         */
//        public static <V> Comparator<LongEntry<V>> comparingByKey(LongComparator cmp) {
...
//         * @since 1.8
//         */
//        public static <V> Comparator<LongEntry<V>> comparingByValue(Comparator<? super V> cmp) {
//            Objects.requireNonNull(cmp);
//            return (Comparator<LongEntry<V>> & Serializable)
