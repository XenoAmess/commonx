...
// * @author XenoAmess
// */
//public interface ShortMap<V> extends Map<Short, V>, Primitive {
//    /**
...
//     * @since 1.2
//     */
//    interface ShortEntry<V> extends Map.Entry<Short, V> {
//        /**
...
//         *                               required to, throw this exception if the entry has been
//         *                               removed from the backing map.
//         * @see ShortEntry#getKey();
//         */
//        short getKeyPrimitive();
//
//        /**
...
//            return Short.hashCode(getKeyPrimitive());
//        }
//
//        /**
...
//         * @since 1.8
//         */
//        public static <V> Comparator<ShortEntry<V>> comparingByKey() {
//            return (Comparator<ShortEntry<V>> & Serializable)
//                    (c1, c2) -> PrimitiveComparators.
//                            SHORT_COMPARATOR_INCREASING.
...
//         * @since 1.8
//         */
//        public static <V> Comparator<ShortEntry<V>> comparingByKey(ShortComparator cmp) {
...
//         * @since 1.8
//         */
//        public static <V> Comparator<ShortEntry<V>> comparingByValue(Comparator<? super V> cmp) {
//            Objects.requireNonNull(cmp);
//            return (Comparator<ShortEntry<V>> & Serializable)
