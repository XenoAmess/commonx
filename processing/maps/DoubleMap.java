...
// * @author XenoAmess
// */
//public interface DoubleMap<V> extends Map<Double, V>, Primitive {
//    /**
...
//     * @since 1.2
//     */
//    interface DoubleEntry<V> extends Map.Entry<Double, V> {
//        /**
...
//         *                               required to, throw this exception if the entry has been
//         *                               removed from the backing map.
//         * @see DoubleEntry#getKey();
//         */
//        double getKeyPrimitive();
//
//        /**
...
//            return Double.hashCode(getKeyPrimitive());
//        }
//
//        /**
...
//         * @since 1.8
//         */
//        public static <V> Comparator<DoubleEntry<V>> comparingByKey() {
//            return (Comparator<DoubleEntry<V>> & Serializable)
//                    (c1, c2) -> PrimitiveComparators.
//                            DOUBLE_COMPARATOR_INCREASING.
...
//         * @since 1.8
//         */
//        public static <V> Comparator<DoubleEntry<V>> comparingByKey(DoubleComparator cmp) {
...
//         * @since 1.8
//         */
//        public static <V> Comparator<DoubleEntry<V>> comparingByValue(Comparator<? super V> cmp) {
//            Objects.requireNonNull(cmp);
//            return (Comparator<DoubleEntry<V>> & Serializable)
