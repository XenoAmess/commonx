...
// * @author XenoAmess
// */
//public interface CharMap<V> extends Map<Character, V>, Primitive {
//    /**
...
//     * @since 1.2
//     */
//    interface CharEntry<V> extends Map.Entry<Character, V> {
//        /**
...
//         *                               required to, throw this exception if the entry has been
//         *                               removed from the backing map.
//         * @see CharEntry#getKey();
//         */
//        char getKeyPrimitive();
//
//        /**
...
//            return Character.hashCode(getKeyPrimitive());
//        }
//
//        /**
...
//         * @since 1.8
//         */
//        public static <V> Comparator<CharEntry<V>> comparingByKey() {
//            return (Comparator<CharEntry<V>> & Serializable)
//                    (c1, c2) -> PrimitiveComparators.
//                            CHAR_COMPARATOR_INCREASING.
...
//         * @since 1.8
//         */
//        public static <V> Comparator<CharEntry<V>> comparingByKey(CharComparator cmp) {
...
//         * @since 1.8
//         */
//        public static <V> Comparator<CharEntry<V>> comparingByValue(Comparator<? super V> cmp) {
//            Objects.requireNonNull(cmp);
//            return (Comparator<CharEntry<V>> & Serializable)
