 ...
 * whose functional method is {@link #test(Integer)}.
 *
 * @author XenoAmess
 * @version 0.8.0
 * @see Predicate
...
public interface IntPredicate extends Predicate<Integer>, Primitive {
    ...
    /**
     * Primitive replacement of test(Integer t)
     *
    ...
    default Predicate<Integer> and(final Predicate<? super Integer> other) {
        ...
        if (other instanceof IntPredicate) {
            return (IntPredicate) t -> IntPredicate.this.testPrimitive(t) && ((IntPredicate) other).testPrimitive(t);
        } else {
     ...
     * to {@link java.util.Objects#equals(Object, Object)}
     */
    static IntPredicate isEqual(int targetPrimitive) {
