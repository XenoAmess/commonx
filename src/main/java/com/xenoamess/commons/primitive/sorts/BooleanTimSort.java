 ...
 * @version 0.6.0
 */
public class BooleanTimSort implements Primitive {
    /**
     ...
     */
    public final BooleanComparator c;
     ...
     */
    public BooleanTimSort(boolean[] a, BooleanComparator c, boolean[] work, int workBase, int workLen) {
        this.a = a;
        this.c = c;
     ...
     * @since 1.8
     */
    public static void sort(boolean[] a, int lo, int hi, BooleanComparator c,
    ...
    public void mergeLo(int base1, int len1, int base2, int len2) {
        ...
        BooleanComparator c = this.c;  // Use local variable for performance
