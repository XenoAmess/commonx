 ...
 * @version 0.6.0
 */
public class DoubleTimSort implements Primitive {
    /**
    ...
    public DoubleTimSort(double[] a, DoubleComparator c, double[] work, int workBase, int workLen) {
        ...
        if (work == null || workLen < tlen || workBase + tlen > work.length) {
            ...
            double[] newArray = new double[tlen];
            tmp = newArray;
            tmpBase = 0;
            tmpLen = tlen;
        } else {
    ...
    public static void sort(double[] a, int lo, int hi, DoubleComparator c,
         ...
         */
        DoubleTimSort ts = new DoubleTimSort(a, c, work, workBase, workLen);
     ...
     */
    public static void reverseRange(double[] a, int lo, int hi) {
        hi--;
        while (lo < hi) {
            double t = a[lo];
            a[lo++] = a[hi];
     ...
     */
    public double[] ensureCapacity(int minCapacity) {
