 ...
 * @version 0.6.0
 */
public class FloatTimSort implements Primitive {
    /**
    ...
    public static void sort(float[] a, int lo, int hi, FloatComparator c,
         ...
         */
        FloatTimSort ts = new FloatTimSort(a, c, work, workBase, workLen);
     ...
     */
    public static void reverseRange(float[] a, int lo, int hi) {
        hi--;
        while (lo < hi) {
            float t = a[lo];
            a[lo++] = a[hi];
     ...
     */
    public float[] ensureCapacity(int minCapacity) {
