 ...
 * @version 0.6.0
 */
public class CharTimSort implements Primitive {
    /**
    ...
    public static void sort(char[] a, int lo, int hi, CharComparator c,
         ...
         */
        CharTimSort ts = new CharTimSort(a, c, work, workBase, workLen);
     ...
     */
    public static void reverseRange(char[] a, int lo, int hi) {
        hi--;
        while (lo < hi) {
            char t = a[lo];
            a[lo++] = a[hi];
