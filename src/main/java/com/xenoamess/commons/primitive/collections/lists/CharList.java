 ...
 * for some implementations (the {@code CharLinkedList} class, for
 ...
 * @see AbstractList
 * @see AbstractCharSequentialList
 * @see List
 * @since 1.2
 */
...
////     */
////    @Override
////    boolean removePrimitive(char o);
...
//    boolean retainAll(Collection<?> c);
    ...
    default void replaceAll(UnaryOperator<Character> operator) {
        ...
        if (operator instanceof CharUnaryOperator) {
            CharUnaryOperator operatorCharUnaryOperator = (CharUnaryOperator) operator;
            while (li.hasNext()) {
                li.setPrimitive(operatorCharUnaryOperator.applyPrimitive(li.nextPrimitive()));
            }
        } else {
            while (li.hasNext()) {
                li.set(operator.apply(li.next()));
    ...
    default void sort(Comparator<? super Character> c) {
        if (c instanceof CharComparator) {
            char[] a = this.toArrayPrimitive();
            Arraysx.sort(a, 0, a.length, (CharComparator) c);
     ...
     * @throws java.lang.IndexOutOfBoundsException     if the index is out of range
     *                                                 ({@code index < 0 || index >= size()})
     * @see #set(int index, Character element)
     */
    default char set(int index, char element) {
        return this.setPrimitive(index, element);
    }
     ...
     * @see #set(int index, Character element)
     */
    char setPrimitive(int index, char element);
     ...
     */
    default void add(int index, char element) {
        this.addPrimitive(index, element);
    }
     ...
     * @see #add(int index, Character element)
     */
    void addPrimitive(int index, char element);
     ...
     */
    char removeByIndexPrimitive(int index);
    ...
    default int indexOf(Object o) {
        ...
        return this.indexOfPrimitive((Character) o);
    }
    ...
    default int lastIndexOf(Object o) {
        ...
        return this.lastIndexOfPrimitive((Character) o);
    }
     ...
     */
    default int lastIndexOf(char o) {
     ...
     * @see #lastIndexOf(Object o)
     */
    int lastIndexOfPrimitive(char o);
    ...
    default CharSpliterator spliterator() {
        if (this instanceof RandomAccess) {
            return new CharRandomAccessSpliterator(this);
        } else {
            return CharSpliterators.spliterator(this, Spliterator.ORDERED);
        }
    }
