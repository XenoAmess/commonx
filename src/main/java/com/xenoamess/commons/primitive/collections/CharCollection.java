...
public interface CharCollection extends Collection<Character>, CharIterable, Primitive {
     ...
     */
    default boolean contains(char o) {
     ...
     * @see #contains(Object o)
     */
    boolean containsPrimitive(char o);
     ...
     * the array.
     *
     * Suppose {@code x} is a char collection.
    ...
    default boolean remove(Object o) {
        ...
        return removeByContentPrimitive((Character) o);
    }
     ...
     * @see #remove(Object o)
     */
    default boolean removeByContent(char o) {
     ...
     * @see #remove(Object o)
     */
    boolean removeByContentPrimitive(char o);
    ...
    default boolean removeIf(Predicate<? super Character> filter) {
        ...
        if (filter instanceof CharPredicate) {
            CharPredicate actionCharPredicate = (CharPredicate) filter;
            while (each.hasNext()) {
                if (actionCharPredicate.testPrimitive(each.nextPrimitive())) {
                    each.remove();
                    removed = true;
                }
            }
