 ...
 * Besides basic {@link BooleanCollection} operations, queues provide
 ...
 * <td>{@link #add(Boolean) add(e)}</td>
 * <td>{@link #offer(Boolean) offer(e)}</td>
 * </tr>
 * <tr>
 ...
 * {@link BooleanLinkedList}, do not prohibit insertion of {@code null}.
 ...
 * @since 1.5
 */
public interface BooleanQueue extends Queue<Boolean>, BooleanCollection, Primitive {
    /**
     ...
     * @return {@code true} (as specified by {@link BooleanCollection#add})
    ...
    /**
     * Primitive replacement of offer(Boolean e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this queue, else
     * {@code false}
     ...
     * @see #offer(Boolean e)
     */
    boolean offerPrimitive(boolean e);
