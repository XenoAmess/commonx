...
public abstract class AbstractBooleanList extends AbstractList<Boolean> implements AbstractBooleanCollection,
    ...
    public final boolean contains(Object o) {
        return BooleanList.super.contains(o);
    }
    ...
    public boolean[] toArrayPrimitive() {
        return AbstractBooleanCollection.super.toArrayPrimitive();
    }
     ...
     * {@inheritDoc}
     * <p>
     * Primitive replacement of add(Boolean e)
     *
     * @see #add(Boolean e)
     */
    @Override
     ...
     * {@inheritDoc}
     * <p>
     * Primitive replacement of set(int index, Boolean element)
     *
     * @implSpec This implementation always throws an
     * {@code UnsupportedOperationException}.
     */
     ...
     * {@inheritDoc}
     * <p>
     * Primitive replacement of add(int index, Boolean element)
     *
     * @see #add(int index, Boolean element)
     */
    @Override
    public final void add(int index, boolean element) {
        this.addPrimitive(index, element);
    ...
    public final int indexOf(Object o) {
        return BooleanList.super.indexOf(o);
    }
     ...
     */
    @Override
    public final int indexOf(boolean o) {
        return BooleanList.super.indexOf(o);
    }
    ...
    public final int lastIndexOf(Object o) {
        return BooleanList.super.lastIndexOf(o);
    }
     ...
     */
    @Override
    public final int lastIndexOf(boolean o) {
        return BooleanList.super.lastIndexOf(o);
    }
    ...
    public int lastIndexOfPrimitive(boolean o) {
        BooleanListIterator it = listIterator(size());
    ...
    public boolean addAll(int index, Collection<? extends Boolean> c) {
        ...
        if (c instanceof BooleanCollection) {
            ...
            BooleanIterator cBooleanCollectionIterator = cBooleanCollection.iterator();
            while (cBooleanCollectionIterator.hasNext()) {
                addPrimitive(index++, cBooleanCollectionIterator.nextPrimitive());
                modified = true;
            }
        } else {
            for (Boolean e : c) {
    ...
    public BooleanIterator iterator() {
        return new AbstractBooleanList.Itr();
    }
    ...
    public BooleanListIterator listIterator(final int index) {
        ...
        return new AbstractBooleanList.ListItr(index);
    }
    ...
    private class Itr implements BooleanIterator {
        ...
        public void remove() {
            ...
            try {
                AbstractBooleanList.this.removeByIndexPrimitive(lastRet);
                if (lastRet < cursor) {
                    cursor--;
                }
                lastRet = -1;
    ...
    private class ListItr extends AbstractBooleanList.Itr implements BooleanListIterator {
        ListItr(int index) {
            cursor = index;
        }
        ...
        public boolean previousPrimitive() {
            ...
            try {
                int i = cursor - 1;
                boolean previous = getPrimitive(i);
                lastRet = cursor = i;
                return previous;
            } catch (IndexOutOfBoundsException e) {
                checkForComodification();
        ...
        public void setPrimitive(boolean e) {
            ...
            try {
                AbstractBooleanList.this.setPrimitive(lastRet, e);
                expectedModCount = modCount;
        ...
        public void addPrimitive(boolean e) {
            ...
            try {
                int i = cursor;
                AbstractBooleanList.this.addPrimitive(i, e);
                lastRet = -1;
                cursor = i + 1;
                expectedModCount = modCount;
            } catch (IndexOutOfBoundsException ex) {
    ...
    public BooleanList subList(int fromIndex, int toIndex) {
        ...
        return (this instanceof RandomAccess ?
                new AbstractBooleanList.BooleanRandomAccessSubList(this, fromIndex, toIndex) :
                new AbstractBooleanList.BooleanSubList(this, fromIndex, toIndex));
    }
    ...
    public boolean equals(Object o) {
        ...
        List<?> oList = (List<?>) o;
        if (oList instanceof BooleanList) {
            BooleanList oBooleanList = (BooleanList) oList;
            BooleanListIterator e2 = oBooleanList.listIterator();
            while (e1.hasNext() && e2.hasNext()) {
                boolean o1 = e1.nextPrimitive();
                boolean o2 = e2.nextPrimitive();
                if (o1 != o2) {
                    return false;
                }
            }
    ...
    public int hashCode() {
        ...
        while (iterator.hasNext()) {
            boolean e = iterator.nextPrimitive();
    ...
    protected void removeRange(int fromIndex, int toIndex) {
        BooleanListIterator it = listIterator(fromIndex);
    ...
    static final class BooleanRandomAccessSpliterator implements BooleanSpliterator {
        ...
        BooleanRandomAccessSpliterator(BooleanList list) {
        ...
        public BooleanSpliterator trySplit() {
            ...
            return (lo >= mid) ? null : // divide range in half unless too small
                    new AbstractBooleanList.BooleanRandomAccessSpliterator(this, lo, index = mid);
        }
    ...
    private static class BooleanSubList extends AbstractBooleanList {
        private final AbstractBooleanList root;
        private final AbstractBooleanList.BooleanSubList parent;
         ...
         */
        public BooleanSubList(AbstractBooleanList root, int fromIndex, int toIndex) {
            this.root = root;
            this.parent = null;
         ...
         */
        protected BooleanSubList(AbstractBooleanList.BooleanSubList parent, int fromIndex, int toIndex) {
        ...
        @Override
        public boolean setPrimitive(int index, boolean element) {
            AbstractBooleanList.checkIndex(index, size);
            checkForComodification();
        ...
        public boolean removeByIndexPrimitive(int index) {
            AbstractBooleanList.checkIndex(index, size);
            checkForComodification();
            boolean result = root.removeByIndexPrimitive(offset + index);
            updateSizeAndModCount(-1);
            return result;
        }
        ...
        private void updateSizeAndModCount(int sizeChange) {
            AbstractBooleanList.BooleanSubList slist = this;
            do {
    ...
    private static class BooleanRandomAccessSubList
            extends AbstractBooleanList.BooleanSubList implements RandomAccess {
        ...
        public BooleanList subList(int fromIndex, int toIndex) {
            subListRangeCheck(fromIndex, toIndex, size);
            return new AbstractBooleanList.BooleanRandomAccessSubList(this, fromIndex, toIndex);
        }
    }
     ...
     * <p>
     * This function is used here in replacement of java.util.AbstractBooleanList.checkIndex(int index, int length),
     * as it is
     * only since java 9.
     *
