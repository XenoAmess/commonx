 ...
 * both ends.  The name <i>deque</i> is short for "byte ended queue"
 ...
 * <td>{@link #addFirst(Byte) addFirst(e)}</td>
 * <td>{@link #offerFirst(Byte) offerFirst(e)}</td>
 * <td>{@link #addLast(Byte) addLast(e)}</td>
 * <td>{@link #offerLast(Byte) offerLast(e)}</td>
 * </tr>
 * <tr>
 ...
 * </table>
 *
 * <p>This interface extends the {@link ByteQueue} interface.  When a deque is
 ...
 * <tbody>
 * <tr>
 * <th scope="row">{@link #add(Byte) add(e)}</th>
 * <td>{@link #addLast(Byte) addLast(e)}</td>
 * </tr>
 * <tr>
 * <th scope="row">{@link #offer(Byte) offer(e)}</th>
 * <td>{@link #offerLast(Byte) offerLast(e)}</td>
 * </tr>
 * <tr>
 ...
 * <tbody>
 * <tr>
 * <th scope="row">{@link #push(Byte) push(e)}</th>
 * <td>{@link #addFirst(Byte) addFirst(e)}</td>
 * </tr>
 * <tr>
 ...
 *
 * <p>Unlike the {@link ByteList} interface, this interface does not
 ...
 * @since 1.6
 */
public interface ByteDeque extends Deque<Byte>, ByteQueue, Primitive {
    /**
    ...
    /**
     * Primitive replacement of addFirst(Byte e)
     *
     * @param e the element to add
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
    ...
    /**
     * Primitive replacement of addLast(Byte e)
     *
     * @param e the element to add
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
     ...
     */
    @Override
    default boolean offerFirst(Byte e) {
        return this.offerFirstPrimitive(e);
    }

    /**
     * Primitive replacement of offerFirst(Byte e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this deque, else
     * {@code false}
     ...
     * @see #offerFirst(Byte e)
     */
    boolean offerFirstPrimitive(byte e);
     ...
     */
    @Override
    default boolean offerLast(Byte e) {
        return this.offerLastPrimitive(e);
    }

    /**
     * Primitive replacement of offerLast(Byte e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this deque, else
     * {@code false}
     ...
     * @see #offerLast(Byte e)
     */
    boolean offerLastPrimitive(byte e);
    ...
    default boolean removeFirstOccurrence(Object o) {
        ...
        return this.removeFirstOccurrencePrimitive((Byte) o);
    }
     ...
     */
    default boolean removeFirstOccurrence(byte o) {
     ...
     * @see #removeFirstOccurrence(Object o)
     */
    boolean removeFirstOccurrencePrimitive(byte o);
    ...
    default boolean removeLastOccurrence(Object o) {
        ...
        return removeLastOccurrencePrimitive((Byte) o);
    }
     ...
     *                              (<a href="{@docRoot}/java.base/java/util/Collection.html#optional-restrictions
     *                              ">optional</a>)
     * @see #removeLastOccurrencePrimitive(byte o)
     */
    default boolean removeLastOccurrence(byte o) {
     ...
     * @see #removeLastOccurrencePrimitive(byte o)
     */
    boolean removeLastOccurrencePrimitive(byte o);
     ...
     */
    @Override
    default boolean offer(Byte e) {
        return ByteQueue.super.offer(e);
    }
     ...
     */
    @Override
    default Byte element() {
        return ByteQueue.super.element();
    }
     ...
     * to call {@link #offer(Byte) offer} separately on each element.
     *
     ...
     */
    @Override
    default void push(Byte e) {
        this.pushPrimitive(e);
    }

    /**
     * Primitive replacement of push(Byte e)
     *
     * @param e the element to push
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
    ...
    default boolean remove(Object o) {
        return ByteQueue.super.remove(o);
    }
    ...
    default boolean contains(Object o) {
        return ByteQueue.super.contains(o);
    }
     ...
     */
    @Override
    ByteIterator descendingIterator();
