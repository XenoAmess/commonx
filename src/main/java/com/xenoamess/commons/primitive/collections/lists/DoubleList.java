...
//    boolean retainAll(Collection<?> c);
    ...
    default void replaceAll(UnaryOperator<Double> operator) {
        ...
        if (operator instanceof DoubleUnaryOperator) {
            DoubleUnaryOperator operatorDoubleUnaryOperator = (DoubleUnaryOperator) operator;
            while (li.hasNext()) {
                li.setPrimitive(operatorDoubleUnaryOperator.applyPrimitive(li.nextPrimitive()));
            }
        } else {
            while (li.hasNext()) {
                li.set(operator.apply(li.next()));
    ...
    default void sort(Comparator<? super Double> c) {
        if (c instanceof DoubleComparator) {
            double[] a = this.toArrayPrimitive();
            Arraysx.sort(a, 0, a.length, (DoubleComparator) c);
    ...
    default int indexOf(Object o) {
        ...
        return this.indexOfPrimitive((Double) o);
    }
    ...
    default int lastIndexOf(Object o) {
        ...
        return this.lastIndexOfPrimitive((Double) o);
    }
     ...
     */
    default int lastIndexOf(double o) {
    ...
    default DoubleSpliterator spliterator() {
        if (this instanceof RandomAccess) {
            return new DoubleRandomAccessSpliterator(this);
        } else {
            return DoubleSpliterators.spliterator(this, Spliterator.ORDERED);
        }
    }
