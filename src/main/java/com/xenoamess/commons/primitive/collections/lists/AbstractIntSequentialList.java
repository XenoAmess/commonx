...
public abstract class AbstractIntSequentialList extends AbstractIntList implements Primitive {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected AbstractIntSequentialList() {
    }
        ...
        try {
            ...
            if (c instanceof IntCollection) {
                ...
                while (cIntCollectionIterator.hasNext()) {
                    e1.addPrimitive(cIntCollectionIterator.nextPrimitive());
                    modified = true;
                }
            } else {
                for (Integer e : c) {
