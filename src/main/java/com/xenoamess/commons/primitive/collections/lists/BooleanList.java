 ...
 * for some implementations (the {@code BooleanLinkedList} class, for
 ...
 * @see AbstractList
 * @see AbstractBooleanSequentialList
 * @see List
 * @since 1.2
 */
...
////     */
////    @Override
////    default boolean remove(boolean o) {
...
////     */
////    @Override
////    boolean removePrimitive(boolean o);
...
//    boolean retainAll(Collection<?> c);
    ...
    default void replaceAll(UnaryOperator<Boolean> operator) {
        ...
        final BooleanListIterator li = this.listIterator();
        if (operator instanceof BooleanUnaryOperator) {
            BooleanUnaryOperator operatorBooleanUnaryOperator = (BooleanUnaryOperator) operator;
            while (li.hasNext()) {
                li.setPrimitive(operatorBooleanUnaryOperator.applyPrimitive(li.nextPrimitive()));
            }
        } else {
            while (li.hasNext()) {
                li.set(operator.apply(li.next()));
    ...
    default void sort(Comparator<? super Boolean> c) {
        if (c instanceof BooleanComparator) {
            boolean[] a = this.toArrayPrimitive();
            Arraysx.sort(a, 0, a.length, (BooleanComparator) c);
     ...
     * @throws java.lang.IndexOutOfBoundsException     if the index is out of range
     *                                                 ({@code index < 0 || index >= size()})
     * @see #set(int index, Boolean element)
     */
    default boolean set(int index, boolean element) {
        return this.setPrimitive(index, element);
    }
     ...
     * @see #add(int index, Boolean element)
     */
    void addPrimitive(int index, boolean element);
     ...
     */
    boolean removeByIndexPrimitive(int index);
    ...
    default int indexOf(Object o) {
        ...
        return this.indexOfPrimitive((Boolean) o);
    }
     ...
     */
    int indexOfPrimitive(boolean o);
    ...
    default int lastIndexOf(Object o) {
        ...
        return this.lastIndexOfPrimitive((Boolean) o);
    }
     ...
     */
    default int lastIndexOf(boolean o) {
     ...
     * @see #lastIndexOf(Object o)
     */
    int lastIndexOfPrimitive(boolean o);
    ...
    default BooleanSpliterator spliterator() {
        if (this instanceof RandomAccess) {
            return new BooleanRandomAccessSpliterator(this);
        } else {
            return BooleanSpliterators.spliterator(this, Spliterator.ORDERED);
        }
    }
