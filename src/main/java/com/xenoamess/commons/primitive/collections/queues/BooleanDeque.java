 ...
 * both ends.  The name <i>deque</i> is short for "boolean ended queue"
 ...
 * <td>{@link #addFirst(Boolean) addFirst(e)}</td>
 * <td>{@link #offerFirst(Boolean) offerFirst(e)}</td>
 * <td>{@link #addLast(Boolean) addLast(e)}</td>
 * <td>{@link #offerLast(Boolean) offerLast(e)}</td>
 * </tr>
 * <tr>
 ...
 * </table>
 *
 * <p>This interface extends the {@link BooleanQueue} interface.  When a deque is
 ...
 * <tbody>
 * <tr>
 * <th scope="row">{@link #add(Boolean) add(e)}</th>
 * <td>{@link #addLast(Boolean) addLast(e)}</td>
 * </tr>
 * <tr>
 * <th scope="row">{@link #offer(Boolean) offer(e)}</th>
 * <td>{@link #offerLast(Boolean) offerLast(e)}</td>
 * </tr>
 * <tr>
 ...
 * <tbody>
 * <tr>
 * <th scope="row">{@link #push(Boolean) push(e)}</th>
 * <td>{@link #addFirst(Boolean) addFirst(e)}</td>
 * </tr>
 * <tr>
 ...
 *
 * <p>Unlike the {@link BooleanList} interface, this interface does not
 ...
 * @since 1.6
 */
public interface BooleanDeque extends Deque<Boolean>, BooleanQueue, Primitive {
    /**
