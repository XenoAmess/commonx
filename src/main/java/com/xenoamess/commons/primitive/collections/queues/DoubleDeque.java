 ...
 * <td>{@link #addFirst(Double) addFirst(e)}</td>
 * <td>{@link #offerFirst(Double) offerFirst(e)}</td>
 * <td>{@link #addLast(Double) addLast(e)}</td>
 * <td>{@link #offerLast(Double) offerLast(e)}</td>
 * </tr>
 * <tr>
 ...
 * </table>
 *
 * <p>This interface extends the {@link DoubleQueue} interface.  When a deque is
 ...
 * <tbody>
 * <tr>
 * <th scope="row">{@link #add(Double) add(e)}</th>
 * <td>{@link #addLast(Double) addLast(e)}</td>
 * </tr>
 * <tr>
 * <th scope="row">{@link #offer(Double) offer(e)}</th>
 * <td>{@link #offerLast(Double) offerLast(e)}</td>
 * </tr>
 * <tr>
 ...
 * <tbody>
 * <tr>
 * <th scope="row">{@link #push(Double) push(e)}</th>
 * <td>{@link #addFirst(Double) addFirst(e)}</td>
 * </tr>
 * <tr>
 ...
 *
 * <p>Unlike the {@link DoubleList} interface, this interface does not
 ...
 * @since 1.6
 */
public interface DoubleDeque extends Deque<Double>, DoubleQueue, Primitive {
    /**
    ...
    /**
     * Primitive replacement of addFirst(Double e)
     *
     * @param e the element to add
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
     ...
     * @see #addFirst(Double e)
     */
    void addFirstPrimitive(double e);
    ...
    /**
     * Primitive replacement of addLast(Double e)
     *
     * @param e the element to add
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
     ...
     * @see #addLast(Double e)
     */
    void addLastPrimitive(double e);
     ...
     */
    @Override
    default boolean offerFirst(Double e) {
        return this.offerFirstPrimitive(e);
    }

    /**
     * Primitive replacement of offerFirst(Double e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this deque, else
     * {@code false}
     ...
     * @see #offerFirst(Double e)
     */
    boolean offerFirstPrimitive(double e);
     ...
     */
    @Override
    default boolean offerLast(Double e) {
        return this.offerLastPrimitive(e);
    }

    /**
     * Primitive replacement of offerLast(Double e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this deque, else
     * {@code false}
     ...
     * @see #offerLast(Double e)
     */
    boolean offerLastPrimitive(double e);
    ...
    default boolean removeFirstOccurrence(Object o) {
        ...
        return this.removeFirstOccurrencePrimitive((Double) o);
    }
     ...
     */
    default boolean removeFirstOccurrence(double o) {
     ...
     * @see #removeFirstOccurrence(Object o)
     */
    boolean removeFirstOccurrencePrimitive(double o);
    ...
    default boolean removeLastOccurrence(Object o) {
        ...
        return removeLastOccurrencePrimitive((Double) o);
    }
     ...
     *                              (<a href="{@docRoot}/java.base/java/util/Collection.html#optional-restrictions
     *                              ">optional</a>)
     * @see #removeLastOccurrencePrimitive(double o)
     */
    default boolean removeLastOccurrence(double o) {
     ...
     * @see #removeLastOccurrencePrimitive(double o)
     */
    boolean removeLastOccurrencePrimitive(double o);
    ...
    default boolean add(Double e) {
        return DoubleQueue.super.add(e);
    }
    ...
    default boolean offer(Double e) {
        return DoubleQueue.super.offer(e);
    }
    ...
    default Double remove() {
        return DoubleQueue.super.remove();
    }
    ...
    default Double element() {
        return DoubleQueue.super.element();
    }
     ...
     */
    @Override
    default void push(Double e) {
        this.pushPrimitive(e);
    }

    /**
     * Primitive replacement of push(Double e)
     *
     * @param e the element to push
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
    ...
    default boolean remove(Object o) {
        return DoubleQueue.super.remove(o);
    }
    ...
    default boolean contains(Object o) {
        return DoubleQueue.super.contains(o);
    }
     ...
     */
    @Override
    DoubleIterator descendingIterator();
