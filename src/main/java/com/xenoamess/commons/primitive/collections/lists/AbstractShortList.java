 ...
 * override the {@link #set(int, Short) set(int, E)} method (which otherwise
 * throws an {@code UnsupportedOperationException}).  If the list is
 * variable-size the programmer must additionally override the
 * {@link #add(int, Short) add(int, E)} and {@link #remove(int)} methods.
 *
 ...
 * methods:
 * {@link #get(int)},
 * {@link #set(int, Short) set(int, E)},
 * {@link #add(int, Short) add(int, E)} and
 * {@link #remove(int)}.
 *
...
public abstract class AbstractShortList extends AbstractList<Short> implements AbstractShortCollection, ShortList
     ...
     */
    public final Short removeByIndex(int index) {
    ...
    public final int indexOf(Object o) {
        return ShortList.super.indexOf(o);
    }
     ...
     */
    @Override
    public final int indexOf(short o) {
        return ShortList.super.indexOf(o);
    }
    ...
    public final int lastIndexOf(Object o) {
        return ShortList.super.lastIndexOf(o);
    }
     ...
     */
    @Override
    public final int lastIndexOf(short o) {
        return ShortList.super.lastIndexOf(o);
    }
