...
public interface LongCollection extends Collection<Long>, LongIterable, Primitive {
    ...
    /**
     * Returns an long array containing all of the elements in this long collection.
     * If this long collection makes any guarantees as to what order its elements
    ...
    /**
     * Returns an array containing all of the elements in this long collection;
     * the runtime type of the returned array is that of the specified array.
     * If the long collection fits in the specified array, it is returned therein.
     * Otherwise, a new array is allocated with the runtime type of the
     * specified array and the size of this long collection.
     *
     ...
     *
     * <p>If this long collection makes any guarantees as to what order its elements
     * are returned by its iterator, this method must return the elements in
     * the same order.
     *
     ...
     * Use {@link #toArrayPrimitive()} to create an array whose runtime type is {@code long[]},
     * or use {@link #toArray(IntFunction)} to control the runtime type of
     * the array.
     *
     * <p>Suppose {@code x} is a long collection.
     * The following code can be used to dump the collection into a previously
     * allocated {@code long} array:
     *
     * <pre>
     ...
     * @apiNote This method acts as a bridge between array-based and collection-based APIs.
     * It allows creation of an array of a particular runtime type. Use
     * {@link #toArrayPrimitive()} to create an array whose runtime type is {@code long[]},
     * or use {@link #toArrayPrimitive(long[])} to reuse an existing array.
     *
     * <p>Suppose {@code x} is a collection known to contain only strings.
     * The following code can be used to dump the collection into a newly
     * allocated array of {@code long}:
     *
     * <pre>
     *     long[] y = x.toArrayPrimitive(long[]::new);</pre>
     * @implSpec The default implementation calls the generator function with zero
     * and then passes the resulting array to {@link #toArrayPrimitive(long[])}.
     * @since 11
     */
    default long[] toArrayPrimitive(IntFunction<long[]> generator) {
     ...
     * @see #add(Long e)
     */
    default boolean addPrimitive(long e) {
