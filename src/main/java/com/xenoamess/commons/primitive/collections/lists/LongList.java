...
import com.xenoamess.commons.primitive.functions.LongUnaryOperator;
import com.xenoamess.commons.primitive.iterators.LongListIterator;
import com.xenoamess.commons.primitive.iterators.LongRandomAccessSpliterator;
 ...
 * for some implementations (the {@code LongLinkedList} class, for
 ...
 * @see AbstractList
 * @see AbstractLongSequentialList
 * @see List
 * @since 1.2
 */
public interface LongList extends List<Long>, LongCollection, Primitive {
    /**
...
////     */
////    @Override
////    boolean removePrimitive(long o);
...
//    boolean retainAll(Collection<?> c);
    ...
    default void replaceAll(UnaryOperator<Long> operator) {
        ...
        if (operator instanceof LongUnaryOperator) {
            LongUnaryOperator operatorLongUnaryOperator = (LongUnaryOperator) operator;
            while (li.hasNext()) {
                li.setPrimitive(operatorLongUnaryOperator.applyPrimitive(li.nextPrimitive()));
            }
        } else {
            while (li.hasNext()) {
                li.set(operator.apply(li.next()));
    ...
    default void sort(Comparator<? super Long> c) {
        if (c instanceof LongComparator) {
            long[] a = this.toArrayPrimitive();
            Arraysx.sort(a, 0, a.length, (LongComparator) c);
     ...
     * @throws java.lang.IndexOutOfBoundsException     if the index is out of range
     *                                                 ({@code index < 0 || index >= size()})
     * @see #set(int index, Long element)
     */
    default long set(int index, long element) {
        return this.setPrimitive(index, element);
    }
     ...
     * @see #add(int index, Long element)
     */
    void addPrimitive(int index, long element);
     ...
     */
    long removeByIndexPrimitive(int index);
    ...
    default int indexOf(Object o) {
        ...
        return this.indexOfPrimitive((Long) o);
    }
    ...
    default int lastIndexOf(Object o) {
        ...
        return this.lastIndexOfPrimitive((Long) o);
    }
     ...
     */
    default int lastIndexOf(long o) {
     ...
     * @see #lastIndexOf(Object o)
     */
    int lastIndexOfPrimitive(long o);
    ...
    default LongSpliterator spliterator() {
        if (this instanceof RandomAccess) {
            return new LongRandomAccessSpliterator(this);
        } else {
            return LongSpliterators.spliterator(this, Spliterator.ORDERED);
        }
    }
