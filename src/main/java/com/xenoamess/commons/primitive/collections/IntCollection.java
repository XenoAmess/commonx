...
import com.xenoamess.commons.primitive.functions.IntPredicate;
 ...
 * @since 1.2
 */
public interface IntCollection extends Collection<Integer>, IntIterable, Primitive {
    // Query Operations
     ...
     */
    default boolean contains(int o) {
     ...
     * @see #contains(Object o)
     */
    boolean containsPrimitive(int o);
    ...
    /**
     * Returns an int array containing all of the elements in this int collection.
     * If this int collection makes any guarantees as to what order its elements
    ...
    /**
     * Returns an array containing all of the elements in this int collection;
     * the runtime type of the returned array is that of the specified array.
     * If the int collection fits in the specified array, it is returned therein.
     * Otherwise, a new array is allocated with the runtime type of the
     * specified array and the size of this int collection.
     *
     ...
     *
     * <p>If this int collection makes any guarantees as to what order its elements
     * are returned by its iterator, this method must return the elements in
     * the same order.
     *
     ...
     * Use {@link #toArrayPrimitive()} to create an array whose runtime type is {@code int[]},
     * or use {@link #toArray(IntFunction)} to control the runtime type of
     * the array.
     *
     * <p>Suppose {@code x} is a int collection.
     * The following code can be used to dump the collection into a previously
     * allocated {@code int} array:
     *
     * <pre>
     ...
     * @apiNote This method acts as a bridge between array-based and collection-based APIs.
     * It allows creation of an array of a particular runtime type. Use
     * {@link #toArrayPrimitive()} to create an array whose runtime type is {@code int[]},
     * or use {@link #toArrayPrimitive(int[])} to reuse an existing array.
     *
     * <p>Suppose {@code x} is a collection known to contain only strings.
     * The following code can be used to dump the collection into a newly
     * allocated array of {@code int}:
     *
     * <pre>
     *     int[] y = x.toArrayPrimitive(int[]::new);</pre>
     * @implSpec The default implementation calls the generator function with zero
     * and then passes the resulting array to {@link #toArrayPrimitive(int[])}.
     * @since 11
     */
    default int[] toArrayPrimitive(IntFunction<int[]> generator) {
     ...
     * @see #add(Integer e)
     */
    default boolean addPrimitive(int e) {
    ...
    default boolean remove(Object o) {
        ...
        return removeByContentPrimitive((Integer) o);
    }
     ...
     * @see #remove(Object o)
     */
    default boolean removeByContent(int o) {
     ...
     * @see #remove(Object o)
     */
    boolean removeByContentPrimitive(int o);
    ...
    default boolean removeIf(Predicate<? super Integer> filter) {
        ...
        if (filter instanceof IntPredicate) {
            IntPredicate actionIntPredicate = (IntPredicate) filter;
            while (each.hasNext()) {
                if (actionIntPredicate.testPrimitive(each.nextPrimitive())) {
                    each.remove();
                    removed = true;
                }
            }
    ...
    default IntSpliterator spliterator() {
        return IntSpliterators.spliterator(this, 0);
    }
