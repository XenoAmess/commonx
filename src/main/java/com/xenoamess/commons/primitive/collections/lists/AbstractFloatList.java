 ...
 * override the {@link #set(int, Float) set(int, E)} method (which otherwise
 * throws an {@code UnsupportedOperationException}).  If the list is
 * variable-size the programmer must additionally override the
 * {@link #add(int, Float) add(int, E)} and {@link #remove(int)} methods.
 *
 ...
 * methods:
 * {@link #get(int)},
 * {@link #set(int, Float) set(int, E)},
 * {@link #add(int, Float) add(int, E)} and
 * {@link #remove(int)}.
 *
 ...
 * @since 1.2
 */
public abstract class AbstractFloatList extends AbstractList<Float> implements AbstractFloatCollection, FloatList
        , Primitive {
    /**
    ...
    public final boolean contains(Object o) {
        return FloatList.super.contains(o);
    }
    ...
    public float[] toArrayPrimitive() {
        return AbstractFloatCollection.super.toArrayPrimitive();
    }
     ...
     * {@link #add(int, Float) add(int, E)} is overridden.
     */
    @Override
     ...
     * {@inheritDoc}
     * <p>
     * Primitive replacement of set(int index, Float element)
     *
     * @implSpec This implementation always throws an
     * {@code UnsupportedOperationException}.
     */
     ...
     * {@inheritDoc}
     * <p>
     * Primitive replacement of add(int index, Float element)
     *
     * @see #add(int index, Float element)
     */
    @Override
    public final void add(int index, float element) {
        this.addPrimitive(index, element);
     ...
     */
    public final Float removeByIndex(int index) {
    ...
    public final int indexOf(Object o) {
        return FloatList.super.indexOf(o);
    }
     ...
     */
    @Override
    public final int indexOf(float o) {
        return FloatList.super.indexOf(o);
    }
    ...
    public final int lastIndexOf(Object o) {
        return FloatList.super.lastIndexOf(o);
    }
     ...
     */
    @Override
    public final int lastIndexOf(float o) {
        return FloatList.super.lastIndexOf(o);
    }
    ...
    public int lastIndexOfPrimitive(float o) {
        FloatListIterator it = listIterator(size());
    ...
    public boolean addAll(int index, Collection<? extends Float> c) {
        ...
        if (c instanceof FloatCollection) {
            ...
            FloatIterator cFloatCollectionIterator = cFloatCollection.iterator();
            while (cFloatCollectionIterator.hasNext()) {
                addPrimitive(index++, cFloatCollectionIterator.nextPrimitive());
                modified = true;
            }
        } else {
            for (Float e : c) {
    ...
    public FloatIterator iterator() {
        return new AbstractFloatList.Itr();
    }
    ...
    public FloatListIterator listIterator(final int index) {
        ...
        return new AbstractFloatList.ListItr(index);
    }
    ...
    private class Itr implements FloatIterator {
        ...
        public void remove() {
            ...
            try {
                AbstractFloatList.this.removeByIndexPrimitive(lastRet);
                if (lastRet < cursor) {
                    cursor--;
                }
                lastRet = -1;
    ...
    private class ListItr extends AbstractFloatList.Itr implements FloatListIterator {
        ListItr(int index) {
            cursor = index;
        }
        ...
        public void setPrimitive(float e) {
            ...
            try {
                AbstractFloatList.this.setPrimitive(lastRet, e);
                expectedModCount = modCount;
        ...
        public void addPrimitive(float e) {
            ...
            try {
                int i = cursor;
                AbstractFloatList.this.addPrimitive(i, e);
                lastRet = -1;
                cursor = i + 1;
                expectedModCount = modCount;
            } catch (IndexOutOfBoundsException ex) {
    ...
    public FloatList subList(int fromIndex, int toIndex) {
        ...
        return (this instanceof RandomAccess ?
                new AbstractFloatList.FloatRandomAccessSubList(this, fromIndex, toIndex) :
                new AbstractFloatList.FloatSubList(this, fromIndex, toIndex));
    }
    ...
    public boolean equals(Object o) {
        ...
        List<?> oList = (List<?>) o;
        if (oList instanceof FloatList) {
            FloatList oFloatList = (FloatList) oList;
            FloatListIterator e2 = oFloatList.listIterator();
            while (e1.hasNext() && e2.hasNext()) {
                float o1 = e1.nextPrimitive();
                float o2 = e2.nextPrimitive();
                if (o1 != o2) {
                    return false;
                }
            }
    ...
    public int hashCode() {
        ...
        while (iterator.hasNext()) {
            float e = iterator.nextPrimitive();
    ...
    protected void removeRange(int fromIndex, int toIndex) {
        FloatListIterator it = listIterator(fromIndex);
    ...
    static final class FloatRandomAccessSpliterator implements FloatSpliterator {
        ...
        FloatRandomAccessSpliterator(FloatList list) {
         ...
         */
        private FloatRandomAccessSpliterator(AbstractFloatList.FloatRandomAccessSpliterator parent,
        ...
        public FloatSpliterator trySplit() {
            ...
            return (lo >= mid) ? null : // divide range in half unless too small
                    new AbstractFloatList.FloatRandomAccessSpliterator(this, lo, index = mid);
        }
    ...
    private static class FloatSubList extends AbstractFloatList {
        private final AbstractFloatList root;
        private final AbstractFloatList.FloatSubList parent;
         ...
         */
        public FloatSubList(AbstractFloatList root, int fromIndex, int toIndex) {
            this.root = root;
            this.parent = null;
         ...
         */
        protected FloatSubList(AbstractFloatList.FloatSubList parent, int fromIndex, int toIndex) {
        ...
        @Override
        public float setPrimitive(int index, float element) {
            AbstractFloatList.checkIndex(index, size);
            checkForComodification();
        ...
        public float removeByIndexPrimitive(int index) {
            AbstractFloatList.checkIndex(index, size);
            checkForComodification();
            float result = root.removeByIndexPrimitive(offset + index);
            updateSizeAndModCount(-1);
            return result;
        }
        ...
        private void updateSizeAndModCount(int sizeChange) {
            AbstractFloatList.FloatSubList slist = this;
            do {
    ...
    private static class FloatRandomAccessSubList
            extends AbstractFloatList.FloatSubList implements RandomAccess {

        /**
         * Constructs a sublist of an arbitrary AbstractList, which is
         * not a RandomAccessSubList itself.
         */
        FloatRandomAccessSubList(AbstractFloatList root,
         ...
         */
        FloatRandomAccessSubList(AbstractFloatList.FloatRandomAccessSubList parent,
                                 int fromIndex, int toIndex) {
        ...
        public FloatList subList(int fromIndex, int toIndex) {
            subListRangeCheck(fromIndex, toIndex, size);
            return new AbstractFloatList.FloatRandomAccessSubList(this, fromIndex, toIndex);
        }
    }
     ...
     * <p>
     * This function is used here in replacement of java.util.AbstractFloatList.checkIndex(int index, int length),
     * as it is
     * only since java 9.
     *
