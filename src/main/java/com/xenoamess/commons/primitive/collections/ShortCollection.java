...
public interface ShortCollection extends Collection<Short>, ShortIterable, Primitive {
    ...
    default boolean contains(Object o) {
        ...
        return this.containsPrimitive((Short) o);
    }
     ...
     */
    default boolean contains(short o) {
     ...
     * @see #contains(Object o)
     */
    boolean containsPrimitive(short o);
    ...
    /**
     * Returns an short array containing all of the elements in this short collection.
     * If this short collection makes any guarantees as to what order its elements
    ...
    /**
     * Returns an array containing all of the elements in this short collection;
     * the runtime type of the returned array is that of the specified array.
     * If the short collection fits in the specified array, it is returned therein.
     * Otherwise, a new array is allocated with the runtime type of the
     * specified array and the size of this short collection.
     *
     ...
     *
     * <p>If this short collection makes any guarantees as to what order its elements
     * are returned by its iterator, this method must return the elements in
     * the same order.
     *
     ...
     * Use {@link #toArrayPrimitive()} to create an array whose runtime type is {@code short[]},
     * or use {@link #toArray(IntFunction)} to control the runtime type of
     * the array.
     *
     * <p>Suppose {@code x} is a short collection.
     * The following code can be used to dump the collection into a previously
     * allocated {@code short} array:
     *
     * <pre>
     ...
     * {@code toArray()}.
     */
    short[] toArrayPrimitive(short[] a);
     ...
     * @apiNote This method acts as a bridge between array-based and collection-based APIs.
     * It allows creation of an array of a particular runtime type. Use
     * {@link #toArrayPrimitive()} to create an array whose runtime type is {@code short[]},
     * or use {@link #toArrayPrimitive(short[])} to reuse an existing array.
     *
     * <p>Suppose {@code x} is a collection known to contain only strings.
     * The following code can be used to dump the collection into a newly
     * allocated array of {@code short}:
     *
     * <pre>
     *     short[] y = x.toArrayPrimitive(short[]::new);</pre>
     * @implSpec The default implementation calls the generator function with zero
     * and then passes the resulting array to {@link #toArrayPrimitive(short[])}.
     * @since 11
     */
    default short[] toArrayPrimitive(IntFunction<short[]> generator) {
     ...
     * @see #add(Short e)
     */
    default boolean addPrimitive(short e) {
    ...
    default boolean remove(Object o) {
        ...
        return removeByContentPrimitive((Short) o);
    }
     ...
     * @see #remove(Object o)
     */
    default boolean removeByContent(short o) {
     ...
     * @see #remove(Object o)
     */
    boolean removeByContentPrimitive(short o);
    ...
    default boolean removeIf(Predicate<? super Short> filter) {
        ...
        if (filter instanceof ShortPredicate) {
            ShortPredicate actionShortPredicate = (ShortPredicate) filter;
            while (each.hasNext()) {
                if (actionShortPredicate.testPrimitive(each.nextPrimitive())) {
                    each.remove();
                    removed = true;
                }
            }
