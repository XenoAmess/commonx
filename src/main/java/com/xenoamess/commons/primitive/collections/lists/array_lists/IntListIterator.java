...
public interface IntListIterator extends IntIterator, ListIterator<Integer> {
     ...
     * {@inheritDoc}
     * <p>
     * Primitive replacement of {@code IntListIterator.next()}
     *
     * @see IntListIterator#next()
     */
    @Override
    int nextPrimitive();
    ...
    /**
     * Primitive replacement of {@code IntListIterator.previous()}
     *
    ...
    /**
     * Primitive replacement of {@code IntListIterator.set(Integer e)}
     *
     ...
     *                                                 {@code next} or {@code previous}
     * @see IntListIterator#set(Integer e)
     */
    void setPrimitive(int e);
    ...
    /**
     * Primitive replacement of {@code IntListIterator.add(Integer e)}
     *
     ...
     *                                                 prevents it from being added to this list
     * @see IntListIterator#add(Integer e)
     */
    void addPrimitive(int e);
}
