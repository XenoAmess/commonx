 ...
 * Besides basic {@link DoubleCollection} operations, queues provide
 ...
 * <td>{@link #add(Double) add(e)}</td>
 * <td>{@link #offer(Double) offer(e)}</td>
 * </tr>
 * <tr>
 ...
 * {@link DoubleLinkedList}, do not prohibit insertion of {@code null}.
 ...
 * @since 1.5
 */
public interface DoubleQueue extends Queue<Double>, DoubleCollection, Primitive {
    /**
     ...
     * @return {@code true} (as specified by {@link DoubleCollection#add})
    ...
    /**
     * Primitive replacement of offer(Double e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this queue, else
     * {@code false}
     ...
     * @see #offer(Double e)
     */
    boolean offerPrimitive(double e);
