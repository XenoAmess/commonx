 ...
 * @since 1.5
 */
public interface DoubleIterable extends Iterable<Double>, Primitive {
    /**
     * {@inheritDoc}
     * <p>
    ...
    default void forEach(Consumer<? super Double> action) {
        ...
        if (action instanceof DoubleConsumer) {
            ...
            while (doubleIterator.hasNext()) {
                actionDoubleConsumer.acceptPrimitive(doubleIterator.nextPrimitive());
            }
        } else {
            for (Double t : this) {
                action.accept(t);
    ...
    default DoubleSpliterator spliterator() {
        return DoubleSpliterators.spliteratorUnknownSize(iterator(), 0);
    }
}
