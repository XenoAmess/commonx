...
public interface ByteListIterator extends ByteIterator, ListIterator<Byte> {
    ...
    @Override
    default Byte next() {
        return ByteIterator.super.next();
    }

    /**
     * {@inheritDoc}
     * <p>
     * Primitive replacement of {@code ByteListIterator.next()}
     *
     * @see ByteListIterator#next()
     */
    @Override
    byte nextPrimitive();
    ...
    /**
     * Primitive replacement of {@code ByteListIterator.previous()}
     *
     * @return {@code true} if the list iterator has more elements when
     * traversing the list in the reverse direction
     * @see ByteListIterator#previous()
     */
    ...
    /**
     * Primitive replacement of {@code ByteListIterator.set(Byte e)}
     *
     ...
     *                                                 {@code next} or {@code previous}
     * @see ByteListIterator#set(Byte e)
     */
    void setPrimitive(byte e);
    ...
    /**
     * Primitive replacement of {@code ByteListIterator.add(Byte e)}
     *
     ...
     *                                                 prevents it from being added to this list
     * @see ByteListIterator#add(Byte e)
     */
    void addPrimitive(byte e);
}
