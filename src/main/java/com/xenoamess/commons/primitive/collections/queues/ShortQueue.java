 ...
 * Besides basic {@link ShortCollection} operations, queues provide
 ...
 * <td>{@link #add(Short) add(e)}</td>
 * <td>{@link #offer(Short) offer(e)}</td>
 * </tr>
 * <tr>
 ...
 * {@link ShortLinkedList}, do not prohibit insertion of {@code null}.
 ...
 * @since 1.5
 */
public interface ShortQueue extends Queue<Short>, ShortCollection, Primitive {
    /**
     ...
     * @return {@code true} (as specified by {@link ShortCollection#add})
    ...
    /**
     * Primitive replacement of offer(Short e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this queue, else
     * {@code false}
     ...
     * @see #offer(Short e)
     */
    boolean offerPrimitive(short e);
