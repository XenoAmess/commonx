 ...
 * override the {@link #set(int, Integer) set(int, E)} method (which otherwise
 * throws an {@code UnsupportedOperationException}).  If the list is
 * variable-size the programmer must additionally override the
 * {@link #add(int, Integer) add(int, E)} and {@link #remove(int)} methods.
 *
 ...
 * methods:
 * {@link #get(int)},
 * {@link #set(int, Integer) set(int, E)},
 * {@link #add(int, Integer) add(int, E)} and
 * {@link #remove(int)}.
 *
...
public abstract class AbstractIntList extends AbstractList<Integer> implements AbstractIntCollection, IntList
    ...
    public final boolean contains(Object o) {
        return IntList.super.contains(o);
    }
    ...
    public int[] toArrayPrimitive() {
        return AbstractIntCollection.super.toArrayPrimitive();
    }
     ...
     * {@link #add(int, Integer) add(int, E)} is overridden.
     */
    @Override
     ...
     */
    public final Integer removeByIndex(int index) {
    ...
    public final int indexOf(Object o) {
        return IntList.super.indexOf(o);
    }
    ...
    public final int lastIndexOf(Object o) {
        return IntList.super.lastIndexOf(o);
    }
    ...
    public boolean addAll(int index, Collection<? extends Integer> c) {
        ...
        if (c instanceof IntCollection) {
            ...
            while (cIntCollectionIterator.hasNext()) {
                addPrimitive(index++, cIntCollectionIterator.nextPrimitive());
                modified = true;
            }
        } else {
            for (Integer e : c) {
    ...
    private class Itr implements IntIterator {
        ...
        public void remove() {
            ...
            try {
                AbstractIntList.this.removeByIndexPrimitive(lastRet);
                if (lastRet < cursor) {
                    cursor--;
                }
                lastRet = -1;
    ...
    private class ListItr extends AbstractIntList.Itr implements IntListIterator {
        ...
        public void setPrimitive(int e) {
            ...
            try {
                AbstractIntList.this.setPrimitive(lastRet, e);
                expectedModCount = modCount;
        ...
        public void addPrimitive(int e) {
            ...
            try {
                int i = cursor;
                AbstractIntList.this.addPrimitive(i, e);
                lastRet = -1;
                cursor = i + 1;
                expectedModCount = modCount;
            } catch (IndexOutOfBoundsException ex) {
    ...
    public IntList subList(int fromIndex, int toIndex) {
        ...
        return (this instanceof RandomAccess ?
                new AbstractIntList.IntRandomAccessSubList(this, fromIndex, toIndex) :
                new AbstractIntList.IntSubList(this, fromIndex, toIndex));
    }
    ...
    public boolean equals(Object o) {
        ...
        List<?> oList = (List<?>) o;
        if (oList instanceof IntList) {
            IntList oIntList = (IntList) oList;
            IntListIterator e2 = oIntList.listIterator();
            while (e1.hasNext() && e2.hasNext()) {
                int o1 = e1.nextPrimitive();
                int o2 = e2.nextPrimitive();
                if (o1 != o2) {
                    return false;
                }
            }
    ...
    static final class IntRandomAccessSpliterator implements IntSpliterator {
        ...
        IntRandomAccessSpliterator(IntList list) {
        ...
        public IntSpliterator trySplit() {
            ...
            return (lo >= mid) ? null : // divide range in half unless too small
                    new AbstractIntList.IntRandomAccessSpliterator(this, lo, index = mid);
        }
    ...
    private static class IntSubList extends AbstractIntList {
        private final AbstractIntList root;
        private final AbstractIntList.IntSubList parent;
         ...
         */
        public IntSubList(AbstractIntList root, int fromIndex, int toIndex) {
            this.root = root;
            this.parent = null;
         ...
         */
        protected IntSubList(AbstractIntList.IntSubList parent, int fromIndex, int toIndex) {
        ...
        @Override
        public int setPrimitive(int index, int element) {
            AbstractIntList.checkIndex(index, size);
            checkForComodification();
        ...
        public int removeByIndexPrimitive(int index) {
            AbstractIntList.checkIndex(index, size);
            checkForComodification();
            int result = root.removeByIndexPrimitive(offset + index);
            updateSizeAndModCount(-1);
            return result;
        }
        ...
        public IntList subList(int fromIndex, int toIndex) {
            subListRangeCheck(fromIndex, toIndex, size);
            return new AbstractIntList.IntSubList(this, fromIndex, toIndex);
        }
        ...
        private void updateSizeAndModCount(int sizeChange) {
            AbstractIntList.IntSubList slist = this;
            do {
    ...
    private static class IntRandomAccessSubList
            extends AbstractIntList.IntSubList implements RandomAccess {
        ...
        public IntList subList(int fromIndex, int toIndex) {
            subListRangeCheck(fromIndex, toIndex, size);
            return new AbstractIntList.IntRandomAccessSubList(this, fromIndex, toIndex);
        }
    }
     ...
     * <p>
     * This function is used here in replacement of java.util.AbstractIntList.checkIndex(int index, int length),
     * as it is
     * only since java 9.
     *
