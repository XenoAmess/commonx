 ...
 * both ends.  The name <i>deque</i> is short for "char ended queue"
 ...
 * <td>{@link #addFirst(Character) addFirst(e)}</td>
 * <td>{@link #offerFirst(Character) offerFirst(e)}</td>
 * <td>{@link #addLast(Character) addLast(e)}</td>
 * <td>{@link #offerLast(Character) offerLast(e)}</td>
 * </tr>
 * <tr>
 ...
 * <tbody>
 * <tr>
 * <th scope="row">{@link #add(Character) add(e)}</th>
 * <td>{@link #addLast(Character) addLast(e)}</td>
 * </tr>
 * <tr>
 * <th scope="row">{@link #offer(Character) offer(e)}</th>
 * <td>{@link #offerLast(Character) offerLast(e)}</td>
 * </tr>
 * <tr>
 ...
 * <tbody>
 * <tr>
 * <th scope="row">{@link #push(Character) push(e)}</th>
 * <td>{@link #addFirst(Character) addFirst(e)}</td>
 * </tr>
 * <tr>
 ...
 * @since 1.6
 */
public interface CharDeque extends Deque<Character>, CharQueue, Primitive {
    /**
     ...
     */
    @Override
    default void addFirst(Character e) {
        this.addFirstPrimitive(e);
    }

    /**
     * Primitive replacement of addFirst(Character e)
     *
     * @param e the element to add
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
     ...
     * @throws IllegalArgumentException if some property of the specified
     *                                  element prevents it from being added to this deque
     * @see #addFirst(Character e)
     */
    default void addFirst(char e) {
        this.addFirstPrimitive(e);
    }
     ...
     */
    @Override
    default void addLast(Character e) {
        this.addLastPrimitive(e);
    }

    /**
     * Primitive replacement of addLast(Character e)
     *
     * @param e the element to add
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
     ...
     * @throws IllegalArgumentException if some property of the specified
     *                                  element prevents it from being added to this deque
     * @see #addLast(Character e)
     */
    default void addLast(char e) {
        this.addLastPrimitive(e);
    }
     ...
     */
    @Override
    default boolean offerFirst(Character e) {
        return this.offerFirstPrimitive(e);
    }

    /**
     * Primitive replacement of offerFirst(Character e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this deque, else
     * {@code false}
     ...
     * @throws IllegalArgumentException if some property of the specified
     *                                  element prevents it from being added to this deque
     * @see #offerFirst(Character e)
     */
    default boolean offerFirst(char e) {
        return this.offerFirstPrimitive(e);
    }
     ...
     * @see #offerFirst(Character e)
     */
    boolean offerFirstPrimitive(char e);
     ...
     */
    @Override
    default boolean offerLast(Character e) {
        return this.offerLastPrimitive(e);
    }

    /**
     * Primitive replacement of offerLast(Character e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this deque, else
     * {@code false}
     ...
     * @throws IllegalArgumentException if some property of the specified
     *                                  element prevents it from being added to this deque
     * @see #offerLast(Character e)
     */
    default boolean offerLast(char e) {
        return this.offerLastPrimitive(e);
    }
     ...
     * @see #offerLast(Character e)
     */
    boolean offerLastPrimitive(char e);
    ...
    default boolean removeFirstOccurrence(Object o) {
        ...
        return this.removeFirstOccurrencePrimitive((Character) o);
    }
     ...
     */
    default boolean removeFirstOccurrence(char o) {
     ...
     * @see #removeFirstOccurrence(Object o)
     */
    boolean removeFirstOccurrencePrimitive(char o);
    ...
    default boolean removeLastOccurrence(Object o) {
        ...
        return removeLastOccurrencePrimitive((Character) o);
    }
     ...
     *                              (<a href="{@docRoot}/java.base/java/util/Collection.html#optional-restrictions
     *                              ">optional</a>)
     * @see #removeLastOccurrencePrimitive(char o)
     */
    default boolean removeLastOccurrence(char o) {
     ...
     * @see #removeLastOccurrencePrimitive(char o)
     */
    boolean removeLastOccurrencePrimitive(char o);
     ...
     */
    @Override
    default boolean add(Character e) {
        return CharQueue.super.add(e);
    }
     ...
     */
    @Override
    default boolean offer(Character e) {
        return CharQueue.super.offer(e);
    }
     ...
     */
    @Override
    default Character remove() {
        return CharQueue.super.remove();
    }
     ...
     */
    @Override
    default Character poll() {
        return CharQueue.super.poll();
    }
    ...
    default Character element() {
        return CharQueue.super.element();
    }
     ...
     */
    @Override
    default void push(Character e) {
        this.pushPrimitive(e);
    }

    /**
     * Primitive replacement of push(Character e)
     *
     * @param e the element to push
     * @throws IllegalStateException    if the element cannot be added at this
     *                                  time due to capacity restrictions
     ...
     * @throws IllegalArgumentException if some property of the specified
     *                                  element prevents it from being added to this deque
     * @see #push(Character e)
     */
    default void push(char e) {
        this.pushPrimitive(e);
    }
    ...
    default boolean remove(Object o) {
        return CharQueue.super.remove(o);
    }
    ...
    default boolean contains(Object o) {
        return CharQueue.super.contains(o);
    }
     ...
     */
    @Override
    CharIterator descendingIterator();
