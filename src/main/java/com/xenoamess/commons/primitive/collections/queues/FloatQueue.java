 ...
 * Besides basic {@link FloatCollection} operations, queues provide
 ...
 * <td>{@link #add(Float) add(e)}</td>
 * <td>{@link #offer(Float) offer(e)}</td>
 * </tr>
 * <tr>
 ...
 * {@link FloatLinkedList}, do not prohibit insertion of {@code null}.
 ...
 * @since 1.5
 */
public interface FloatQueue extends Queue<Float>, FloatCollection, Primitive {
    /**
     ...
     * @return {@code true} (as specified by {@link FloatCollection#add})
    ...
    /**
     * Primitive replacement of offer(Float e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this queue, else
     * {@code false}
     ...
     * @see #offer(Float e)
     */
    boolean offerPrimitive(float e);
