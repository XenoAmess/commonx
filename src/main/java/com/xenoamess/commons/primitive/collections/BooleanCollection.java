...
import com.xenoamess.commons.primitive.functions.BooleanPredicate;
 ...
 * @since 1.2
 */
public interface BooleanCollection extends Collection<Boolean>, BooleanIterable, Primitive {
    // Query Operations
    ...
    default boolean contains(Object o) {
        ...
        return this.containsPrimitive((Boolean) o);
    }
     ...
     */
    default boolean contains(boolean o) {
     ...
     * @see #contains(Object o)
     */
    boolean containsPrimitive(boolean o);
    ...
    /**
     * Returns an boolean array containing all of the elements in this boolean collection.
     * If this boolean collection makes any guarantees as to what order its elements
    ...
    /**
     * Returns an array containing all of the elements in this boolean collection;
     * the runtime type of the returned array is that of the specified array.
     * If the boolean collection fits in the specified array, it is returned therein.
     * Otherwise, a new array is allocated with the runtime type of the
     * specified array and the size of this boolean collection.
     *
     ...
     *
     * <p>If this boolean collection makes any guarantees as to what order its elements
     * are returned by its iterator, this method must return the elements in
     * the same order.
     *
     ...
     * Use {@link #toArrayPrimitive()} to create an array whose runtime type is {@code boolean[]},
     * or use {@link #toArray(IntFunction)} to control the runtime type of
     * the array.
     *
     * <p>Suppose {@code x} is a boolean collection.
     * The following code can be used to dump the collection into a previously
     * allocated {@code boolean} array:
     *
     * <pre>
     ...
     * {@code toArray()}.
     */
    boolean[] toArrayPrimitive(boolean[] a);
     ...
     * @apiNote This method acts as a bridge between array-based and collection-based APIs.
     * It allows creation of an array of a particular runtime type. Use
     * {@link #toArrayPrimitive()} to create an array whose runtime type is {@code boolean[]},
     * or use {@link #toArrayPrimitive(boolean[])} to reuse an existing array.
     *
     * <p>Suppose {@code x} is a collection known to contain only strings.
     * The following code can be used to dump the collection into a newly
     * allocated array of {@code boolean}:
     *
     * <pre>
     *     boolean[] y = x.toArrayPrimitive(boolean[]::new);</pre>
     * @implSpec The default implementation calls the generator function with zero
     * and then passes the resulting array to {@link #toArrayPrimitive(boolean[])}.
     * @since 11
     */
    default boolean[] toArrayPrimitive(IntFunction<boolean[]> generator) {
     ...
     * @see #add(Boolean e)
     */
    default boolean addPrimitive(boolean e) {
    ...
    default boolean remove(Object o) {
        ...
        return removeByContentPrimitive((Boolean) o);
    }
     ...
     * @see #remove(Object o)
     */
    default boolean removeByContent(boolean o) {
     ...
     * @see #remove(Object o)
     */
    boolean removeByContentPrimitive(boolean o);
    ...
    default boolean removeIf(Predicate<? super Boolean> filter) {
        ...
        if (filter instanceof BooleanPredicate) {
            BooleanPredicate actionBooleanPredicate = (BooleanPredicate) filter;
            while (each.hasNext()) {
                if (actionBooleanPredicate.testPrimitive(each.nextPrimitive())) {
                    each.remove();
                    removed = true;
                }
            }
    ...
    default BooleanSpliterator spliterator() {
        return BooleanSpliterators.spliterator(this, 0);
    }
     ...
     */
    @Override
    default Stream<Boolean> parallelStream() {
