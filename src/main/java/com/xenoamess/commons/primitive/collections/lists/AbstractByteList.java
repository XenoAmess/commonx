 ...
 * override the {@link #set(int, Byte) set(int, E)} method (which otherwise
 * throws an {@code UnsupportedOperationException}).  If the list is
 * variable-size the programmer must additionally override the
 * {@link #add(int, Byte) add(int, E)} and {@link #remove(int)} methods.
 *
 ...
 * methods:
 * {@link #get(int)},
 * {@link #set(int, Byte) set(int, E)},
 * {@link #add(int, Byte) add(int, E)} and
 * {@link #remove(int)}.
 *
...
public abstract class AbstractByteList extends AbstractList<Byte> implements AbstractByteCollection, ByteList
     ...
     */
    public final Byte removeByIndex(int index) {
    ...
    public final int indexOf(Object o) {
        return ByteList.super.indexOf(o);
    }
    ...
    public final int lastIndexOf(Object o) {
        return ByteList.super.lastIndexOf(o);
    }
     ...
     */
    @Override
    public final int lastIndexOf(byte o) {
        return ByteList.super.lastIndexOf(o);
    }
