 ...
 * Besides basic {@link LongCollection} operations, queues provide
 ...
 * <td>{@link #add(Long) add(e)}</td>
 * <td>{@link #offer(Long) offer(e)}</td>
 * </tr>
 * <tr>
 ...
 * {@link LongLinkedList}, do not prohibit insertion of {@code null}.
 ...
 * @since 1.5
 */
public interface LongQueue extends Queue<Long>, LongCollection, Primitive {
    /**
     ...
     * @return {@code true} (as specified by {@link LongCollection#add})
    ...
    /**
     * Primitive replacement of offer(Long e)
     *
     * @param e the element to add
     * @return {@code true} if the element was added to this queue, else
     * {@code false}
