...
/**
 * An abstract {@code ByteSpliterator.ByteOfByte} that implements
 ...
 * (see {@link com.xenoamess.commons.primitive.iterators.ByteSpliterators#spliterator(ByteIterator, long, int)}.
 ...
 * @since 1.8
 */
public abstract class AbstractByteSpliterator implements ByteSpliterator.ByteOfByte, Primitive {
     ...
     */
    protected AbstractByteSpliterator(long est, int additionalCharacteristics) {
        this.est = est;
        this.characteristics = ((additionalCharacteristics & ByteSpliterator.SIZED) != 0)
                ? additionalCharacteristics | ByteSpliterator.SUBSIZED
                : additionalCharacteristics;
    }

    static final class HoldingByteConsumer implements ByteConsumer {
        byte value;

        @Override
        public void acceptPrimitive(byte value) {
            this.value = value;
        }
    }
     ...
     */
    @Override
    public ByteSpliterator.ByteOfByte trySplit() {
