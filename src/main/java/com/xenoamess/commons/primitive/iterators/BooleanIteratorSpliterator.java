...
public class BooleanIteratorSpliterator implements BooleanSpliterator.BooleanOfBoolean {
     ...
     *                        source or elements.
     * @param collection      a {@link com.xenoamess.commons.primitive.collections.BooleanCollection} object.
     */
    public BooleanIteratorSpliterator(BooleanCollection collection, int characteristics) {
     ...
     *                        source or elements.
     */
    public BooleanIteratorSpliterator(BooleanIterator iterator, long size, int characteristics) {
        this.collection = null;
        this.it = iterator;
        this.est = size;
        this.characteristics = (characteristics & BooleanSpliterator.CONCURRENT) == 0
                ? characteristics | BooleanSpliterator.SIZED | BooleanSpliterator.SUBSIZED
                : characteristics;
    }
     ...
     *                        source or elements.
     */
    public BooleanIteratorSpliterator(BooleanIterator iterator, int characteristics) {
        this.collection = null;
        this.it = iterator;
        this.est = Long.MAX_VALUE;
        this.characteristics = characteristics & ~(Spliterator.SIZED | BooleanSpliterator.SUBSIZED);
    }
     ...
     */
    @Override
    public BooleanOfBoolean trySplit() {
        /*
