 ...
 * {@link com.xenoamess.commons.primitive.iterators.ShortSpliterators}
 *
 * @author XenoAmess
 * @version 0.8.0
 * @see ShortSpliterators
...
public final class ShortSpliterators implements Primitive {
    ...
    private static final ShortSpliterator.ShortOfShort EMPTY_SHORT_SPLITERATOR =
            new EmptySpliterator.ShortOfShort();
...
//     */
//    public static ShortSpliterator spliterator(Object[] array,
//                                                int additionalCharacteristics) {
//        return new ShortArraySpliterator(Objects.requireNonNull(array),
...
//     */
//    public static ShortSpliterator spliterator(Object[] array, int fromIndex, int toIndex,
//                                                int additionalCharacteristics) {
//        checkFromToBounds(Objects.requireNonNull(array).length, fromIndex, toIndex);
//        return new ShortArraySpliterator(array, fromIndex, toIndex, additionalCharacteristics);
//    }
     ...
     * fine control over Spliterator characteristics.  Most other situations in
     * which a Spliterator for an array is needed should use
     * {@link java.util.Arrays#spliterator(short[])}.
     *
     * <p>The returned spliterator always reports the characteristics
     * {@code SIZED} and {@code SUBSIZED}.  The caller may provide additional
     * characteristics for the spliterator to report; it is common to
     ...
     * @see Arrays#spliterator(short[])
     */
    public static ShortSpliterator.ShortOfShort spliterator(short[] array,
                                                            int additionalCharacteristics) {
        return new ShortArraySpliterator(Objects.requireNonNull(array), additionalCharacteristics);
    }
     ...
     * fine control over Spliterator characteristics.  Most other situations in
     * which a Spliterator for an array is needed should use
     * {@link java.util.Arrays#spliterator(short[], int, int)}.
     *
     * <p>The returned spliterator always reports the characteristics
     * {@code SIZED} and {@code SUBSIZED}.  The caller may provide additional
     ...
     *                                                  {@code toIndex} is less than {@code fromIndex}, or
     *                                                  {@code toIndex} is greater than the array size
     * @see Arrays#spliterator(short[], int, int)
     */
    public static ShortSpliterator.ShortOfShort spliterator(short[] array, int fromIndex, int toIndex,
                                                            int additionalCharacteristics) {
        checkFromToBounds(Objects.requireNonNull(array).length, fromIndex, toIndex);
        return new ShortArraySpliterator(array, fromIndex, toIndex, additionalCharacteristics);
    }
     ...
     */
    public static ShortSpliterator spliterator(ShortCollection c,
                                               int characteristics) {
        return new ShortIteratorSpliterator(Objects.requireNonNull(c),
                characteristics);
    }
...
//     */
//    public static <T> ShortSpliterator spliterator(Iterator<? extends T> iterator,
//                                                    long size,
//                                                    int characteristics) {
//        return new ShortIteratorSpliterator(Objects.requireNonNull(iterator), size,
//                characteristics);
//    }
...
//     * @throws NullPointerException if the given iterator is {@code null}
//     */
//    public static ShortSpliterator spliteratorUnknownSize(Iterator<? extends Short> iterator,
//                                                           int characteristics) {
//        return new ShortIteratorSpliterator(Objects.requireNonNull(iterator), characteristics);
//    }


    /**
     * Creates a {@code ShortSpliterator.ShortOfShort} using a given
     ...
     */
    public static ShortSpliterator.ShortOfShort spliterator(ShortIterator iterator,
                                                            long size,
                                                            int characteristics) {
        return new ShortIteratorSpliterator(Objects.requireNonNull(iterator),
     ...
     * @throws java.lang.NullPointerException if the given iterator is {@code null}
     */
    public static ShortSpliterator.ShortOfShort spliteratorUnknownSize(ShortIterator iterator,
                                                                       int characteristics) {
        return new ShortIteratorSpliterator(Objects.requireNonNull(iterator), characteristics);
    }
     ...
     *
     * @param shortSpliterator The spliterator
     * @return An iterator
    ...
    public static ShortIterator iterator(ShortSpliterator shortSpliterator) {
        ...
        class ShortAdapter implements ShortIterator, ShortConsumer {
            ...
            public boolean hasNext() {
                if (!valueReady) {
                    shortSpliterator.tryAdvance(this);
                }
                return valueReady;
            }
     ...
     * after the iterator is returned.
     *
     * @param shortSpliterator a {@link com.xenoamess.commons.primitive.iterators.ShortSpliterator.ShortOfShort}
     *                         object.
     * @return An iterator
     * @throws java.lang.NullPointerException if the given spliterator is {@code null}
     */
    public static ShortIterator iterator(ShortSpliterator.ShortOfShort shortSpliterator) {
        Objects.requireNonNull(shortSpliterator);
        class Adapter implements ShortIterator, ShortConsumer {
            boolean valueReady = false;
            short nextElement;
    ...
    private abstract static class EmptySpliterator<S extends ShortSpliterator, C> {
        ...
        public int characteristics() {
            return ShortSpliterator.SIZED | ShortSpliterator.SUBSIZED;
        }

        private static final class ShortOfShort
                extends ShortSpliterators.EmptySpliterator<ShortSpliterator.ShortOfShort, ShortConsumer>
                implements ShortSpliterator.ShortOfShort {
            ShortOfShort() {
            }
        }
    }
