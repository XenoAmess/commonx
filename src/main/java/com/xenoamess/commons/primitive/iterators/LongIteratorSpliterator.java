 ...
 * {@link java.util.Spliterator.OfLong long} values.
 ...
 * @since 1.8
 */
public class LongIteratorSpliterator implements LongSpliterator.LongOfLong {
    static final int BATCH_UNIT = 1 << 10;  // batch array size increment
    static final int MAX_BATCH = 1 << 25;  // max batch array size;
    private final LongCollection collection; // null OK
     ...
     *                        source or elements.
     * @param collection      a {@link com.xenoamess.commons.primitive.collections.LongCollection} object.
     */
    public LongIteratorSpliterator(LongCollection collection, int characteristics) {
     ...
     *                        source or elements.
     */
    public LongIteratorSpliterator(LongIterator iterator, long size, int characteristics) {
        this.collection = null;
        this.it = iterator;
        this.est = size;
        this.characteristics = (characteristics & LongSpliterator.CONCURRENT) == 0
                ? characteristics | LongSpliterator.SIZED | LongSpliterator.SUBSIZED
                : characteristics;
    }
     ...
     *                        source or elements.
     */
    public LongIteratorSpliterator(LongIterator iterator, int characteristics) {
        this.collection = null;
        this.it = iterator;
        this.est = Long.MAX_VALUE;
        this.characteristics = characteristics & ~(Spliterator.SIZED | LongSpliterator.SUBSIZED);
    }
