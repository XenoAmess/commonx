 ...
 * {@link java.util.Spliterator.OfShort short} values.
...
public class ShortIteratorSpliterator implements ShortSpliterator.ShortOfShort {
     ...
     *                        source or elements.
     * @param collection      a {@link com.xenoamess.commons.primitive.collections.ShortCollection} object.
     */
    public ShortIteratorSpliterator(ShortCollection collection, int characteristics) {
     ...
     *                        source or elements.
     */
    public ShortIteratorSpliterator(ShortIterator iterator, long size, int characteristics) {
        this.collection = null;
        this.it = iterator;
        this.est = size;
        this.characteristics = (characteristics & ShortSpliterator.CONCURRENT) == 0
                ? characteristics | ShortSpliterator.SIZED | ShortSpliterator.SUBSIZED
                : characteristics;
    }
     ...
     *                        source or elements.
     */
    public ShortIteratorSpliterator(ShortIterator iterator, int characteristics) {
        this.collection = null;
        this.it = iterator;
        this.est = Long.MAX_VALUE;
        this.characteristics = characteristics & ~(Spliterator.SIZED | ShortSpliterator.SUBSIZED);
    }
    ...
    public ShortOfShort trySplit() {
        ...
        if (s > 1 && i.hasNext()) {
            ...
            return new ShortArraySpliterator(a, 0, j, characteristics);
        }
        return null;
    }
