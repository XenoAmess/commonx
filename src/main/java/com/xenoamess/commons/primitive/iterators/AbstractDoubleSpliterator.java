 ...
 * (see {@link DoubleSpliterators#spliterator(DoubleIterator, long, int)}.
 ...
 * @see DoubleSpliterators#spliterator(DoubleIterator, long, int)
 * @since 1.8
 */
public abstract class AbstractDoubleSpliterator implements DoubleSpliterator.DoubleOfDouble {
    ...
    protected AbstractDoubleSpliterator(long est, int additionalCharacteristics) {
        this.est = est;
        this.characteristics = ((additionalCharacteristics & DoubleSpliterator.SIZED) != 0)
                ? additionalCharacteristics | DoubleSpliterator.SUBSIZED
    ...
    static final class HoldingDoubleConsumer implements DoubleConsumer {
        ...
        @Override
        public void acceptPrimitive(double value) {
            this.value = value;
        }
    }
     ...
     */
    @Override
    public DoubleSpliterator.DoubleOfDouble trySplit() {
