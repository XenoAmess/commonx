 ...
 * {@link OfInt int}, {@link OfLong long}, and {@link OfShort short} values.
...
public interface ShortSpliterator extends Spliterator<Short>, Primitive {
     ...
     * @see Spliterator.OfShort
     * @since 1.8
     */
    public interface ShortOfPrimitive<T_CONS, T_SPLITR extends ShortSpliterator.ShortOfPrimitive<T_CONS, T_SPLITR>>
            extends ShortSpliterator, Spliterator.OfPrimitive<Short, T_CONS, T_SPLITR> {
        @Override
        T_SPLITR trySplit();
     ...
     * @since 1.8
     */
    public interface ShortOfShort
            extends ShortSpliterator.ShortOfPrimitive
            <ShortConsumer, ShortSpliterator.ShortOfShort> {

        @Override
        ShortOfShort trySplit();
         ...
         * {@inheritDoc}
         *
         * @implSpec If the action is an instance of {@code ShortConsumer} then it is
         * cast to {@code ShortConsumer} and passed to
         * {@link #tryAdvance(ShortConsumer)}; otherwise
         * the action is adapted to an instance of {@code ShortConsumer}, by
         * boxing the argument of {@code ShortConsumer}, and then passed to
         * {@link #tryAdvance(ShortConsumer)}.
         */
        @Override
...
//                            "{0} calling Spliterator.OfShort.tryAdvance((ShortConsumer) action::accept)");
//                }
         ...
         * @implSpec If the action is an instance of {@code ShortConsumer} then it is
         * cast to {@code ShortConsumer} and passed to
         * {@link #forEachRemaining(ShortConsumer)};
         * otherwise the action is adapted to an instance of
         * {@code ShortConsumer}, by boxing the argument of
         * {@code ShortConsumer}, and then passed to
         * {@link #forEachRemaining(ShortConsumer)}.
         */
        @Override
...
//                if (Tripwire.ENABLED) {
//                    Tripwire.trip(getClass(),
//                            "{0} calling Spliterator.OfShort.forEachRemaining((ShortConsumer) action::accept)");
//                }
