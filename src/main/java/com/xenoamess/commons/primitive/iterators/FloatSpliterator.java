 ...
 * {@link OfInt int}, {@link OfLong long}, and {@link OfFloat float} values.
...
public interface FloatSpliterator extends Spliterator<Float>, Primitive {
     ...
     * @see Spliterator.OfFloat
     * @since 1.8
     */
    public interface FloatOfPrimitive<T_CONS, T_SPLITR extends FloatSpliterator.FloatOfPrimitive<T_CONS, T_SPLITR>>
            extends FloatSpliterator, Spliterator.OfPrimitive<Float, T_CONS, T_SPLITR> {
        @Override
        T_SPLITR trySplit();
    ...
    /**
     * A Spliterator specialized for {@code float} values.
     *
     * @since 1.8
     */
    public interface FloatOfFloat
            extends FloatSpliterator.FloatOfPrimitive
            <FloatConsumer, FloatSpliterator.FloatOfFloat> {

        @Override
        FloatOfFloat trySplit();
         ...
         * {@link #tryAdvance(FloatConsumer)}; otherwise
         * the action is adapted to an instance of {@code FloatConsumer}, by
         * boxing the argument of {@code FloatConsumer}, and then passed to
         * {@link #tryAdvance(FloatConsumer)}.
         */
        @Override
...
//                            "{0} calling Spliterator.OfFloat.tryAdvance((FloatConsumer) action::accept)");
//                }
         ...
         * @implSpec If the action is an instance of {@code FloatConsumer} then it is
         * cast to {@code FloatConsumer} and passed to
         * {@link #forEachRemaining(FloatConsumer)};
         * otherwise the action is adapted to an instance of
         * {@code FloatConsumer}, by boxing the argument of
...
//                if (Tripwire.ENABLED) {
//                    Tripwire.trip(getClass(),
//                            "{0} calling Spliterator.OfFloat.forEachRemaining((FloatConsumer) action::accept)");
//                }
