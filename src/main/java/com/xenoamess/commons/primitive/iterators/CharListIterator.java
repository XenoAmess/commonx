 ...
 * cursor positions:  ^            ^            ^            ^                  ^
 * </PRE>
 * Note that the {@link #remove} and {@link #set(Character)} methods are
 ...
 * @since 1.2
 */
public interface CharListIterator extends CharIterator, ListIterator<Character>, Primitive {
    // Query Operations
    ...
    default Character next() {
        return CharIterator.super.next();
    }

    /**
     * Primitive replacement of {@code CharListIterator.previous()}
     *
     * @return {@code true} if the list iterator has more elements when
     * traversing the list in the reverse direction
     * @see CharListIterator#previous()
     */
    char previousPrimitive();
    ...
    /**
     * Primitive replacement of {@code CharListIterator.set(Character e)}
     *
     ...
     *                                                 {@code next} or {@code previous}
     * @see CharListIterator#set(Character e)
     */
    void setPrimitive(char e);
    ...
    /**
     * Primitive replacement of {@code CharListIterator.add(Character e)}
     *
     ...
     *                                                 prevents it from being added to this list
     * @see CharListIterator#add(Character e)
     */
    void addPrimitive(char e);
}
