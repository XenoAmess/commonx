...
/**
 * A CharSpliterator.CharOfCharacter designed for use by sources that traverse and split
 ...
 * @see CharSpliterator
 */
public class CharArraySpliterator implements CharSpliterator.CharOfCharacter, Primitive {
    ...
    public CharArraySpliterator(char[] array, int origin, int fence, int additionalCharacteristics) {
        ...
        this.index = origin;
        this.fence = fence;
        this.characteristics = additionalCharacteristics | CharSpliterator.SIZED | CharSpliterator.SUBSIZED;
    }
