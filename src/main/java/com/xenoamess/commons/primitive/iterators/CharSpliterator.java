 ...
 * {@link OfInt int}, {@link OfLong long}, and {@link OfCharacter char} values.
...
public interface CharSpliterator extends Spliterator<Character>, Primitive {
     ...
     * @see Spliterator.OfCharacter
     * @since 1.8
     */
    public interface CharOfPrimitive<T_CONS, T_SPLITR extends CharSpliterator.CharOfPrimitive<T_CONS, T_SPLITR>>
            extends CharSpliterator, Spliterator.OfPrimitive<Character, T_CONS, T_SPLITR> {
        @Override
        T_SPLITR trySplit();
     ...
     * @since 1.8
     */
    public interface CharOfCharacter
            extends CharSpliterator.CharOfPrimitive
            <CharConsumer, CharSpliterator.CharOfCharacter> {

        @Override
        CharOfCharacter trySplit();
         ...
         * {@link #tryAdvance(CharConsumer)}; otherwise
         * the action is adapted to an instance of {@code CharConsumer}, by
         * boxing the argument of {@code CharConsumer}, and then passed to
         * {@link #tryAdvance(CharConsumer)}.
         */
        @Override
...
//                            "{0} calling Spliterator.OfCharacter.tryAdvance((CharConsumer) action::accept)");
//                }
         ...
         * @implSpec If the action is an instance of {@code CharConsumer} then it is
         * cast to {@code CharConsumer} and passed to
         * {@link #forEachRemaining(CharConsumer)};
         * otherwise the action is adapted to an instance of
         * {@code CharConsumer}, by boxing the argument of
         * {@code CharConsumer}, and then passed to
         * {@link #forEachRemaining(CharConsumer)}.
         */
        @Override
...
//                if (Tripwire.ENABLED) {
//                    Tripwire.trip(getClass(),
//                            "{0} calling Spliterator.OfCharacter.forEachRemaining((CharConsumer) action::accept)");
//                }
