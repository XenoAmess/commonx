 ...
 * implement {@link #tryAdvance(java.util.function.BooleanConsumer)
 * tryAdvance}.  The extending class should override
 * {@link #forEachRemaining(java.util.function.BooleanConsumer) forEachRemaining}
 ...
 * (see {@link #spliterator(java.util.BooleanIterator, long, int)}.
 ...
 * @see #spliterator(java.util.BooleanIterator, long, int)
 * @since 1.8
 */
public abstract class AbstractBooleanSpliterator implements BooleanSpliterator.BooleanOfBoolean {
     ...
     */
    protected AbstractBooleanSpliterator(long est, int additionalCharacteristics) {
        this.est = est;
        this.characteristics = ((additionalCharacteristics & BooleanSpliterator.SIZED) != 0)
                ? additionalCharacteristics | BooleanSpliterator.SUBSIZED
                : additionalCharacteristics;
    }

    static final class HoldingBooleanConsumer implements BooleanConsumer {
        boolean value;

        @Override
        public void acceptPrimitive(boolean value) {
            this.value = value;
        }
    }
     ...
     */
    @Override
    public BooleanSpliterator.BooleanOfBoolean trySplit() {
        ...
        if (s > 1 && tryAdvance(holder)) {
            ...
            return new BooleanArraySpliterator(a, 0, j, characteristics());
        }
        return null;
    }
