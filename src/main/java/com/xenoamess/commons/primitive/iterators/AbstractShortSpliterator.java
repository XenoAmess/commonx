...
/**
 * An abstract {@code ShortSpliterator.ShortOfShort} that implements
 ...
 * (see {@link com.xenoamess.commons.primitive.iterators.ShortSpliterators#spliterator(ShortIterator, long, int)}.
...
public abstract class AbstractShortSpliterator implements ShortSpliterator.ShortOfShort, Primitive {
     ...
     */
    protected AbstractShortSpliterator(long est, int additionalCharacteristics) {
        this.est = est;
        this.characteristics = ((additionalCharacteristics & ShortSpliterator.SIZED) != 0)
                ? additionalCharacteristics | ShortSpliterator.SUBSIZED
                : additionalCharacteristics;
    }

    static final class HoldingShortConsumer implements ShortConsumer {
        short value;

        @Override
        public void acceptPrimitive(short value) {
            this.value = value;
        }
    }
     ...
     */
    @Override
    public ShortSpliterator.ShortOfShort trySplit() {
