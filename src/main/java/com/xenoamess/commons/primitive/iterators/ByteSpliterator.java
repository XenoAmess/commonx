 ...
 * {@link OfInt int}, {@link OfLong long}, and {@link OfByte byte} values.
...
public interface ByteSpliterator extends Spliterator<Byte>, Primitive {
    ...
    /**
     * A Spliterator specialized for {@code byte} values.
     *
     * @since 1.8
     */
    public interface ByteOfByte
         ...
         * {@inheritDoc}
         *
         * @implSpec If the action is an instance of {@code ByteConsumer} then it is
         * cast to {@code ByteConsumer} and passed to
         * {@link #tryAdvance(ByteConsumer)}; otherwise
         * the action is adapted to an instance of {@code ByteConsumer}, by
         * boxing the argument of {@code ByteConsumer}, and then passed to
         * {@link #tryAdvance(ByteConsumer)}.
         */
        @Override
...
//                }
         ...
         * @implSpec If the action is an instance of {@code ByteConsumer} then it is
         * cast to {@code ByteConsumer} and passed to
         * {@link #forEachRemaining(ByteConsumer)};
         * otherwise the action is adapted to an instance of
         * {@code ByteConsumer}, by boxing the argument of
         * {@code ByteConsumer}, and then passed to
         * {@link #forEachRemaining(ByteConsumer)}.
         */
        @Override
