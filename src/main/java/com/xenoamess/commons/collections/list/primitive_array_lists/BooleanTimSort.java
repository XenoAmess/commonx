...
public class BooleanTimSort {
     ...
     */
    public final Comparator<? super Boolean> c;
     ...
     */
    public BooleanTimSort(boolean[] a, Comparator<? super Boolean> c, boolean[] work, int workBase, int workLen) {
        this.a = a;
        this.c = c;
     ...
     * @since 1.8
     */
    public static void sort(boolean[] a, int lo, int hi, Comparator<? super Boolean> c,
    ...
    public static void binarySort(boolean[] a, int lo, int hi, int start,
     ...
     * the specified array
     */
    public static int countRunAndMakeAscending(boolean[] a, int lo, int hi,
                                               Comparator<? super Boolean> c) {
        assert lo < hi;
        int runHi = lo + 1;
        if (runHi == hi) {
     ...
     */
    public static void reverseRange(boolean[] a, int lo, int hi) {
        hi--;
        while (lo < hi) {
            boolean t = a[lo];
            a[lo++] = a[hi];
    ...
    public static int gallopRight(boolean key, boolean[] a, int base, int len,
                                  int hint, Comparator<? super Boolean> c) {
        assert len > 0 && hint >= 0 && hint < len;
    ...
    public void mergeLo(int base1, int len1, int base2, int len2) {
        ...
        boolean[] a = this.a; // For performance
        boolean[] tmp = ensureCapacity(len1);
        ...
        Comparator<? super Boolean> c = this.c;  // Use local variable for performance
    ...
    public void mergeHi(int base1, int len1, int base2, int len2) {
        ...
        boolean[] a = this.a; // For performance
        boolean[] tmp = ensureCapacity(len2);
