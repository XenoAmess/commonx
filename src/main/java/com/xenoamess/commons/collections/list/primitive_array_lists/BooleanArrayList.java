 ...
 * {@link com.xenoamess.commons.collections.list.primitive_array_lists.BooleanListIterator#remove() remove} or
 * {@link com.xenoamess.commons.collections.list.primitive_array_lists.BooleanListIterator#add(Object) add} methods,
...
public class BooleanArrayList extends PrimitiveArrayList<Boolean> {
    ...
    /**
     * Constructs a BooleanArrayList with a
     *
     * @param booleanArray the collection whose elements are to be placed into this list
     * @throws java.lang.NullPointerException if the specified collection is null
     */
    ...
    public int lastIndexOfRangePrimitive(Object o, int start, int end) {
        ...
        boolean tmpBooleanValue = (Boolean) o;
        boolean[] es = elementData;
    ...
    private static class BooleanSubList extends AbstractList<Boolean> implements RandomAccess {
        ...
        public Spliterator<Boolean> spliterator() {
            ...
            return new Spliterator<Boolean>() {
                ...
                @Override
                public BooleanArrayList.ArrayListSpliterator trySplit() {
    ...
    @Override
    public Spliterator<Boolean> spliterator() {
        return new BooleanArrayList.ArrayListSpliterator(0, -1, 0);
    }

    /**
     * Index-based split-by-two, lazily initialized Spliterator
     */
    final class ArrayListSpliterator implements Spliterator<Boolean> {
        ...
        public BooleanArrayList.ArrayListSpliterator trySplit() {
            int hi = getFence(), lo = index, mid = (lo + hi) >>> 1;
            return (lo >= mid) ? null : // divide range in half unless too small
                    new BooleanArrayList.ArrayListSpliterator(lo, index = mid, expectedModCount);
        }
     ...
     * <p>sort.</p>
     *
     * @param c a {@link com.xenoamess.commons.collections.list.primitive_array_lists.BooleanComparator} object.
     */
