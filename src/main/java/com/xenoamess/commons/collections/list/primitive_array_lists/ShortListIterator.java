 ...
 * @since 1.2
 */
public interface ShortListIterator extends ShortIterator, ListIterator<Short> {
    // Query Operations
     ...
     * {@inheritDoc}
     * <p>
     * Primitive replacement of {@code ShortListIterator.next()}
     *
     * @see ShortListIterator#next()
     */
    @Override
    short nextPrimitive();
