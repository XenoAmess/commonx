...
public class IntArrayListTest {
    ...
    public void checkEqual(IntArrayList a1, ArrayList<Integer> a2) {
        assertEquals(a1.size(), a2.size());
        for (int i = 0; i < a1.size(); i++) {
            assertEquals(a1.get(i), a2.get(i));
            assertEquals(a1.getPrimitive(i), (int) a2.get(i));
        }
        assertEquals(a1, a2);
        assertEquals(a2, a1);
    }
    ...
    public void performanceChecks(int length) {
        ...
        System.out.println("IntArrayList time : " + score1);

        long begin2 = System.currentTimeMillis();
        ArrayList<Integer> a2 = new ArrayList<>();
        for (int i = 0; i < length; i++) {
            a2.add((Integer) data.getPrimitive(i));
        }
        a2.sort(null);
        Object a2c = a2.clone();
        for (int i = 0; i < length; i++) {
            a2.remove((Integer) data.getPrimitive(i));
        }
        long score2 = (System.currentTimeMillis() - begin2);
        System.out.println("ArrayList<Integer> time : " + score2);
